...
For example take a look at the release page for setuptools_openapi_generator-cli here:
https://github.com/garryod/setuptools_openapi_generator-cli/releases/tag/3.3.0
